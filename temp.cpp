...
void action()
{
  ...
  HTuple  hv_Width, hv_Height, hv_BarCodeHandle;
  HTuple  hv_DecodedDataStrings, hv_BarCodeResults, hv_Area;
  HTuple  hv_Row, hv_Column;

  //Ê¶±ðÌõÂë
  ReadImage(&ho_Image, "E:/halcon_data/IMG_20221028_151400");
  Rgb1ToGray(ho_Image, &ho_GrayImage);
  GetImageSize(ho_GrayImage, &hv_Width, &hv_Height);
  //dev_open_window (0, 0, Width, Height, 'black', WindowHandle)
  CreateBarCodeModel("element_size_min", 1.5, &hv_BarCodeHandle);
  FindBarCode(ho_GrayImage, &ho_SymbolRegions, hv_BarCodeHandle, "EAN-13", &hv_DecodedDataStrings);
  GetBarCodeResult(hv_BarCodeHandle, "all", "orientation", &hv_BarCodeResults);
